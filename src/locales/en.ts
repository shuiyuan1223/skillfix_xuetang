...
export const en: LocaleMessages = {
  ...
  dashboard: {
    ...
    scopeErrorHint: 'New data types need updated permissions. Please re-authorize to access all data.',
    reAuth: 'Re-authorize',
  },
  ...
  skills: {
    ...
    skillCatHealthCoaching: 'Health Coaching',
    skillCatHealthManagement: 'Health Management',
  ...
  evolution: {
    ...
    noEvaluationsHint: 'No evaluations yet. Start a conversation to generate evaluations automatically.',
    ...
    config: 'Config',
    configDesc: 'Benchmark scoring categories and dimension weights. Managed as a Skill (benchmark-evaluator).',
    ...
    noConfigFile: 'Benchmark evaluator skill not found. Create it in Settings > Skills to customize scoring.',
    ...
    diagnosePipelineHint: 'Benchmark → Analyze weaknesses → Extract patterns → Generate suggestions',
    ...
    diagnoseSuggestionImprove: 'Improve {{label}} — {{count}} tests failing, {{gap}} points below threshold',
    ...
    proposalHint: 'Ask the agent to generate proposals via chat below, or submit proposals manually',
  ...
  settings: {
    ...
    sectionInfraModels: 'Infrastructure Models',
    agentModelLabel: 'Model',
    agentCtxHealth: 'Health Data Context',
    agentCtxWeather: 'Weather Context',
    agentCtxBootstrap: 'Bootstrap Context',
    agentCtxMemory: 'Memory Summary',
    agentCtxProfile: 'User Profile',
    agentTools: 'Tool Categories',
    agentSkillsTags: 'Skill Tags',
    agentSkillsSection: 'Skills',
    agentAdvancedSkills: 'Advanced Skill Filtering',
    agentSkillsInclude: 'Skills Include',
    agentSkillsExclude: 'Skills Exclude',
    agentSkillHint: 'Skill Hint',
    agentPaths: 'Paths',
    agentAdvanced: 'Advanced',
    agentWorkspace: 'Workspace Path',
    agentSessionPath: 'Session Path',
    defaultModelFallback: '(Default — use global config)',
    saveAgents: 'Save Agent Config',
    saveInfraModels: 'Save Infrastructure Models',
    noneSelected: '(None)',
    sectionContext: 'Context & Proactive',
    contextLocation: 'Weather Location',
    contextHemisphere: 'Hemisphere (Season)',
    hemisphereNorth: 'Northern',
    hemisphereSouth: 'Southern',
    proactiveEnabled: 'Proactive Health',
    proactiveInterval: 'Check Interval (min)',
    ...
    pluginOriginWorkspace: 'Workspace',
    pluginOriginConfig: 'Config Path',
    noPluginsFound: 'No plugins found. Place plugins in .pha/plugins/ or configure paths.',
    saveAll: 'Save All',
