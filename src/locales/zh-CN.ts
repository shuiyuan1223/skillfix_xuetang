...
export const zhCN: LocaleMessages = {
  ...
  evolution: {
    ...
    // Incidents
    incidentsSlackHint: '通过 Slack Webhook 上报的问题，按类型追踪闭环',
    incidentsPending: '待处理',
    incidentsBug: 'Bug 类',
    incidentsEffect: '效果类',
    incidentsResolvedWeek: '本周已闭环',
    incidentsReporter: '上报人',
    incidentsDescription: '描述',
    incidentsEmpty: '暂无 Incidents',
    incidentsEmptyHint: '在 Slack 频道发送消息触发 webhook，或由系统 Agent 自动上报',
    statusPending: '待处理',
    statusConfirmed: '已确认',
    statusSuspended: '已挂起',
    statusResolved: '已解决',
    ...
    playgroundWelcomeDesc: '通过 6 步引导式流程优化你的 Agent：基准测试 → 诊断 → 提案 → 批准 → 执行 → 验证',
    playgroundLog: '流程日志',
