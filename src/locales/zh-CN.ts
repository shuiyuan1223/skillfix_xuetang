...
export const zhCN: LocaleMessages = {
  ...
  evolution: {
    ...
    // Bad Cases
    badCasesSlackHint: "通过 Slack Webhook 上报的问题，按类型追踪闭环",
    badCasesPending: "待处理",
    badCasesBug: "Bug 类",
    badCasesEffect: "效果类",
    badCasesResolvedWeek: "本周已闭环",
    badCasesReporter: "上报人",
    badCasesDescription: "描述",
    badCasesEmpty: "暂无 Bad Cases",
    badCasesEmptyHint: "在 Slack 频道发送消息触发 webhook，或由系统 Agent 自动上报",
    statusPending: "待处理",
    statusConfirmed: "已确认",
    statusSuspended: "已挂起",
    statusResolved: "已解决",
