---
name: heart-monitor
description: "分析心率、HRV 数据并提供心血管健康建议（静息心率评估、运动心率区间、过度训练检测）。当用户问心率、心跳、HRV、心血管相关问题时使用。不适用于：血压问题用 blood-pressure，压力/焦虑用 stress-management，运动表现用 workout-tracker"
metadata:
  {
    "pha": {
      "emoji": "❤️",
      "category": "health-coaching",
      "tags": ["pha", "heart-rate", "hrv", "data-analysis"],
