...
import { printHeader, printKV, printDivider, c, icons, Spinner, fatal, success, info, warn } from '../utils/cli-ui.js';
...
async function handleStart(options: { port?: string; open?: boolean; foreground?: boolean }): Promise<void> {
